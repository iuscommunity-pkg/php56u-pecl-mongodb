# IUS spec file for php56u-pecl-mongodb, forked from:
#
...
%{?with_libbson:BuildRequires: pkgconfig(libbson-1.0) >= 1.6}
%{?with_libmongoc:BuildRequires: pkgconfig(libmongoc-1.0) >= 1.6}
